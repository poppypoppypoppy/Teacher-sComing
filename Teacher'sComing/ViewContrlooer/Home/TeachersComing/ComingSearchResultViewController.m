//
//  ComingSearchResultViewController.m
//  Teacher'sComing
//
...
@interface ComingSearchResultViewController ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,UISearchControllerDelegate,UISearchResultsUpdating>
...
@implementation ComingSearchResultViewController
...
-(void)searchMessageInDB{
    BmobQuery *query = [BmobQuery queryWithClassName:@"coming"];
    //按updatedAt进行降序排列
