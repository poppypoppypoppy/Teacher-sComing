...
//完成按钮
- (void)finish {
    UIAlertController *alertC = [UIAlertController alertControllerWithTitle:@"小狮提醒" message:@"确认修改个人信息？" preferredStyle:UIAlertControllerStyleAlert];
...
//    [self finish];
////    [self presentViewController:kVCFromSb(@"TCLoginViewController", @"Main") animated:YES completion:nil];
//}
