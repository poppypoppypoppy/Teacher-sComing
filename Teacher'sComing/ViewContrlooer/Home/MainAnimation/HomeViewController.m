...
//    self.navigationController.title = @"首页";
    ...
    //设置图片，无用
//    self.tabBarItem.image = [UIImage imageNamed:@"sun3"];
//    self.tabBarItem.selectedImage = [UIImage imageNamed:@"sun3"];
    self.tabBarController.tabBarItem.image = [UIImage imageNamed:@"sun3"];
    self.tabBarController.tabBarItem.selectedImage = [UIImage imageNamed:@"sun3"];
//       self.tabBarItem.badgeValue = @"3";
//    self.tabBarController.tabBarItem.image = [UIImage imageNamed:@"sun3"];
    
    //整个tabbar的背景图
//    self.tabBarController.tabBar.backgroundImage = [UIImage imageNamed:@"sun3"];
    
    //选中后字体颜色设置
    self.tabBarController.tabBar.tintColor = [UIColor orangeColor];
//    self.tabBarController.tabBar.selectionIndicatorImage = [UIImage imageNamed:@"sun3"];
...
//            self.title = mark.subLocality;
//            self.tabBarItem.title = @"首页";
            self.navigationItem.title = mark.subLocality;
        }
    }];
}
/**定位*/
